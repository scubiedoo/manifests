...
execute sudo grep -Fq ".bashrc.chroot" $1/root/.bash_profile || {
	success sudo su -c "\"echo \\\"[ -r /root/setup/.bashrc.chroot ] && { source /root/setup/.bashrc.chroot; }\\\" >> $1/root/.bash_profile\""
}
